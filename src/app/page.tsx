      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-16 relative">
          ...
          <div className="relative bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50">
            <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent mb-6 text-balance">
              React 예제 모음
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-8 text-pretty leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              ...
              <Badge
                variant="secondary"
                className="text-base px-4 py-2 bg-accent/10 text-accent border-accent/20 hover:bg-accent/20 transition-colors"
              >
                JavaScript Concepts
              </Badge>
              <Badge
                variant="secondary"
                className="text-base px-4 py-2 bg-secondary/10 text-secondary border-secondary/20 hover:bg-secondary/20 transition-colors"
              >
                React Hooks
              </Badge>
            </div>
        ...
        {categories.map((category, categoryIndex) => (
          <div key={category} className="mb-16">
            <div className="flex items-center gap-6 mb-8">
              ...
              <Badge
                variant="outline"
                className="text-sm px-3 py-1 bg-card border-border/50"
              >
                {
